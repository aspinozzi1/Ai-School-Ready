...
const PIN_COPY = {
  ...
  'vibe-boss-battle': { pal: P.coral,
    top: 'Your questions', mid: 'are the weapon', big: 'BUILD THE GAME',
    sub: 'Health bars, sprites, sound, screen shake. No logins, no subscription. $19.',
    board: 'Vibe Code Your Own Game',
    desc: 'Vibe code your own game: twelve tasks and you have a real arcade-style review game where your own questions do the damage. Health bars that drain, pixel sprites you draw by typing, sound with no sound files, screen shake and floating damage numbers. One HTML file, no student logins, no subscription, and it runs with the wifi down. Includes the finished game, twelve prompts written out in full, five ways to run it with a class, and a straight page on building in a famous genre without stealing from it. No coding background needed. From two certified teachers.' },
  'what-you-can-borrow': { pal: P.blue,
    top: 'Build the game they love', mid: 'without stealing anybody\u2019s', big: 'HERE IS THE LINE',
    sub: 'How a game works is free. The way somebody said it and drew it is not. Free.',
    board: 'Classroom Games',
    desc: 'Free for teachers making their own classroom games: where the line actually is. How a game works is free to borrow - turn-based battles, collecting things, locked doors, a health bar - and the particular way somebody else said it and drew it is not. Every legal point quoted from the US Copyright Office, including the one teachers miss: names and short phrases carry no copyright but may be trademarks, which is a different law. Inside: two columns of take-it and leave-it, seven checks to run in about four minutes before you share anything, what to do when an AI hands you protected material, and a fill-in page so your own game is documented. Not legal advice. From two certified teachers.' },
  'ye-class-store': { pal: P.grape,
    top: 'They priced it. They stocked it.', mid: 'you built it in front of them', big: 'NOW COUNT THE TIN',
    sub: 'Five days, and the last one is the software against the cash box. $18.',
    board: 'Entrepreneurship for Kids',
    desc: 'A five-day entrepreneurship unit where the deliverable is working software instead of a poster. Your class surveys the room, prices a three-tier shelf and works out a full sell-out by hand, you build the storefront live in front of them, they run a real selling session, and on day five they count the tin against the paper ledger against the app and explain the gap. The working store app is included: one file, a setup screen so you never edit code, a prompt that drafts your whole price list in about thirty seconds, stock that counts down and a last item that stops selling. No accounts for anybody, nothing uploads, and no student ever touches the chatbot. Seven printable student pages. From two certified teachers.' },
  'copy-worthless': { pal: P.coral,
    top: 'Stop trying to catch it', mid: 'design it so it does not work', big: 'MAKE THE COPY WORTHLESS',
    sub: 'Four moves, a before and after each, and one assignment rewritten. Free.',
    board: 'AI and Academic Honesty',
    desc: 'Free for teachers: four ways to design an assignment so a copied answer, from a classmate or from a chatbot, falls apart on its own. No detector, no new software, and nobody gets accused of anything. Inside: why detection is the wrong job with the actual false positive numbers, four moves each with a before and an after, the follow-up question a copied answer cannot survive with a bank of stems to paste under any question, and a fill-in page so you leave with one assignment actually rewritten. Works on paper, in any subject and any grade. From two certified teachers.' },
  'ai-instructions-file': { pal: P.turq,
    top: 'It asks you a question', mid: 'every ninety seconds', big: 'WRITE THIS ONCE',
    sub: 'One page that stops the asking, and stops your project drifting. Free.',
    board: 'AI for Teachers',
    desc: 'Free for teachers building anything with AI: the instructions file. One short page you write once and paste at the start of every chat, saying what the thing is, what it must never do, and what the AI should do when it does not know what you want. Includes a real instructions file from a live classroom project, the one sentence that stops it asking and starts it deciding, and a fill-in page so you leave with your own. No coding, nothing to install. From two certified teachers.' },
  'vibe-long-road': { pal: P.grass,
    top: 'Open the file. It works.', mid: 'your questions, ten minutes', big: 'A REVIEW GAME YOU OWN',
    sub: 'Type them, paste them, or let AI draft the round in thirty seconds. $12.',
    board: 'Vibe Code Your Own Game',
    desc: 'Open the file and it works. Put your own questions in from a setup screen built into the game, or copy the prompt and have AI draft a whole round in about thirty seconds, then save it as your own file to reuse every year. A journey review game where every turn is a choice before it is a question. Students pick the easy road, the steady one or the hard pass that pays, so the thinking starts before the question appears and two students get different journeys. What they get wrong blocks a road on the map until they go back and fix it, and clearing one is the only full-screen celebration in the game. Built on what the research says about motivation: feeling capable is the strongest driver and points do almost nothing for it. No logins, no subscription, no way to lose in front of the class, and it runs with the wifi down. From two certified teachers.' },
  'vibe-roster': { pal: P.blue,
    top: 'A roster in a real database', mid: 'that refuses a last name', big: 'NOT CAREFUL. INCAPABLE.',
    sub: 'Twelve tasks, both files included, nothing installed. $39.',
    board: 'Vibe Coding for Teachers',
    desc: 'Vibe coding for teachers, the real-software tier: build a class roster that lives in an actual database and physically cannot hold a student surname, because the database itself refuses one. Three layers that do not trust each other - the browser shortens, the database refuses, and no column has a place to put it. Twelve prompts written out in full, both working files included, and an honest page about who can read your data. No coding background, nothing installed. From two certified teachers.' },

...
const IMAGES = [
  ...
  ['lrd-whats-inside', whatsInside('Vibe Code Your Own Game \u00b7', 'The Long Road', [
    'Choice before question - the road decides what it asks',
    'Missed ideas block the road until you fix them',
    'The only full-screen moment is fixing a mistake',
    'No way to lose in front of the class, and no ranking',
    'Twelve prompts in full, including what to forbid',
    'The finished game included, played three ways',
  ], 'PDF + HTML')],
  ['lrd-real-pages',   realPages('#6B8F5A', ['lrd_p3.png', 'lrd_p4.png', 'lrd_p14.png'], '29 pages + game')],

...
const IMAGES = [
  ...
  ['cst-the-app', gameShot('cst_app.png', 'The store app, included and ready',
      ...
      'No accounts. Nothing uploads. Works with the wifi down.')],
  ['cst-whats-inside', whatsInside('Vibe Coding for Kids \u00b7', 'The Class Store', [
    'Five days, each ending in something real',
    'The working store app - setup screen, no code',
    'A prompt that drafts your price list in 30 seconds',
    'Seven student pages worth printing',
    'Day 5: count the tin against the software',
    'What to do when the AI breaks it in front of the class',
  ], 'PDF + HTML')],
  ['cst-real-pages', realPages('#2D6CB5', ['cst_p2.png', 'cst_p8.png', 'cst_p16.png'], '24 pages + the app')],
  ...
  ['lrd-the-game', gameShot('lrd_game.png', 'This is the game, and it is ready now',
      ...
      'No logins. No way to lose in front of the class.')],
  ['lrd-whats-inside', whatsInside('Vibe Code Your Own Game \u00b7', 'The Long Road', [
    'Open the file and it works - nothing to install',
    'Your questions in from a setup screen, no code touched',
    'A prompt that has AI draft a round in 30 seconds',
    'Save it as your own file, and reuse it every year',
    'Five ways to run it in class, with timings',
    'Four prompts that change the game itself',
  ], 'PDF + HTML')],
  ['lrd-real-pages',   realPages('#6B8F5A', ['lrd_p2.png', 'lrd_p4.png', 'lrd_p5.png'], '8 pages + the game')],
  ['lrd-setup', gameShot('lrd_setup.png', 'No code. This screen is inside the game.',
      'Type them, paste them,', 'or let AI draft the round',
      'Title \u00b7 destination \u00b7 your questions \u00b7 save it as your own file',
      'Nothing uploads. Nothing leaves the page.')],

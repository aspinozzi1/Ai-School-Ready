...
const PRODUCTS = [
  ...
  { file: 'iep-at-a-glance',     badge: 'Quick Reference',
    kicker: 'Special education · student snapshot',
    title: 'IEP at a Glance:', accent: 'Student Snapshot Sheets',
    lede: 'One page a gen-ed teacher, para, or substitute can actually use — goals, accommodations, services, and contacts.',
    chips: ['2 layouts', 'Guest-teacher card', 'Binder cover + tabs', '$7'] },
  { file: 'iep-goal-tracking',   badge: 'Data Tracking',
    kicker: 'Special education · progress monitoring',
    title: 'IEP Goal Tracking &', accent: 'Data Collection Sheets',
    lede: 'Weekly data, a hand-plotted graph, and an AI page that drafts a progress-report sentence from de-identified scores.',
    chips: ['8 pages', 'Graph + roster', 'AI progress summary', '$9'] },
  { file: 'free-behavior-tracker', badge: 'Free',
    kicker: 'Free resource · special education',
    title: 'Free Behavior', accent: 'Tracker',
    lede: 'A daily point sheet, a frequency tally, and a weekly summary — print and go, no login.',
    chips: ['2 pages', 'Print & go', 'No login', 'Free'] },
  { file: 'homeschool-attendance', badge: 'Free',
    kicker: 'Free resource · homeschool record keeping',
    title: 'Homeschool', accent: 'Attendance Sheet',
    lede: 'A monthly grid, a year-at-a-glance summary against your own target, and a simple subject log.',
    chips: ['3 pages', 'Monthly grid', 'Subject log', 'Free'] },
  { file: 'progress-monitoring-sheets', badge: 'Free',
    kicker: 'Free resource · special education',
  ...
  { file: 'vibe-dashboard', badge: 'Vibe Coding',
    kicker: 'Vibe coding for teachers \u00b7 build 2',
    title: 'Build a Classroom', accent: 'Dashboard That Remembers',
    lede: 'Class list, fair picker, groups, timer and points in one file - and it still knows all of it tomorrow morning.',
    chips: ['23 pages', 'Working app included', '12 prompts', '$24'] },
  { file: 'vibe-boss-battle', badge: 'Vibe Code Your Own Game',
    kicker: 'Build 1 \u00b7 any subject \u00b7 no student logins',
    title: 'The Boss Battle', accent: 'Review Game',
    lede: 'Health bars, sprites, sound and screen shake - and your review questions are the weapon.',
    chips: ['29 pages', 'Game included', '12 tasks', '$19'] },
  { file: 'what-you-can-borrow', badge: 'Free \u00b7 Making Things for Your Class',
    kicker: 'Quoted from the US Copyright Office',
    title: 'What You', accent: 'Can Borrow',
    lede: 'How a game works is free to borrow. The way somebody else said it and drew it is not. Here is the line, and the checklist.',
    chips: ['5 pages', '7 checks', 'Fill-in page', 'Free'] },
  { file: 'ye-class-store', badge: 'Vibe Coding for Kids',
    kicker: '5 days \u00b7 students spec it \u00b7 you build it',
    title: 'The Class Store', accent: 'They Design, You Build',
    lede: 'On the last day they count the tin against what the software says - and find out why the two do not match.',
    chips: ['24 pages', 'App included', '7 printables', '$18'] },
  { file: 'copy-worthless', badge: 'Free \u00b7 AI and Academic Honesty',
    kicker: 'No detector \u00b7 no software \u00b7 nobody accused',
    title: 'Make the Copy', accent: 'Worthless',
    lede: 'Four ways to design an assignment so a copied answer - from a classmate or a chatbot - falls apart on its own.',
    chips: ['5 pages', '4 moves', 'Fill-in page', 'Free'] },
  { file: 'ai-instructions-file', badge: 'Free \u00b7 Building With AI',
    kicker: 'One page, written once, pasted into every chat',
    title: 'The AI', accent: 'Instructions File',
    lede: 'Stop the AI asking you a question every ninety seconds - and stop your project drifting away from what you asked for.',
    chips: ['5 pages', 'A real example', 'Fill-in page', 'Free'] },
  { file: 'vibe-long-road', badge: 'Vibe Code Your Own Game',
    kicker: 'Any subject \u00b7 any grade \u00b7 no logins for anybody',
    title: 'The Long Road', accent: 'Ready In 10 Minutes',
    lede: 'Open the file and it works. Put your own questions in from a setup screen - or have AI draft the whole round in thirty seconds.',
    chips: ['The game', '8 pages', '10 minutes', '$12'] },
  { file: 'vibe-roster', badge: 'Vibe Coding \u00b7 Real Software',
    kicker: 'Teacher vibe coding \u00b7 the database tier',
    title: 'Build a Roster That', accent: 'Cannot Store Last Names',
    lede: 'A class list in a real database, on every computer you own - and the database itself refuses a surname.',
    chips: ['29 pages', 'Both files included', '12 tasks', '$39'] },
  { file: 'pitch-to-prototype', badge: 'Vibe Coding for Kids',
    kicker: 'Young entrepreneurs \u00b7 five-day unit \u00b7 grades 4-8',
    title: 'Pitch to', accent: 'Prototype',
    lede: 'Your class finds a real problem, writes the spec, and watches you build the app live on the board. The deliverable is working software, not a poster.',
    chips: ['21 pages', 'Example app included', '6 student pages', '$18'] },

...
const APP=fs.readFileSync(path.join(__dirname,'class-store.html'),'utf8');
...
<div class="foot"><span>${stu?'The Class Store':'Vibe Coding for Kids &middot; The Class Store'}</span><span>Bright Scholar · AI-Ready School</span></div>

...
Human-authorship chain for "AI for Planning & Differentiation."

| Stage | Date | Notes |
|---|---|---|
| Drafted (AI-assisted, per transparency statement) | 2026-08-07 | Full 9-component draft per approved Kit 1/2 template and KIT_STANDARD |
| Sources verified | 2026-08-07 | 9 sources confirmed via live web search; see RESEARCH_LOG.md |
| Founder-input slots placed | 2026-08-07 | 2 × FOUNDER STORY, 1 × YOUR TAKE, 1 × LOCAL EXAMPLE (see script's amber callouts) |
| Founder review (humanization pass) | _pending_ | Owners: run kits/tooling/HUMANIZATION_CHECKLIST.md at batch audit |
| What the owners changed/added | _pending_ | |
| Founder stories & stances added | 2026-08-08 | Katelyn (slide 2): 8th grade literature class; differentiation favored students beneath grade level, scaffolds took precedence over stretching. Second story slot REMOVED at owners' direction (no authentic example; honest beats padded). Shared take (slide 18): equity in practice favors the struggling child; the top end gets forgotten; build the stretch on purpose. Adam (lab): levels reading level of safety training materials and tests/quizzes so understanding is equal |

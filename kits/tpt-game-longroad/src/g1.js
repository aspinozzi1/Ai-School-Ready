...
const APP=fs.readFileSync(path.join(__dirname,'long-road.html'),'utf8');
...
<div class="foot"><span>${stu?'Vibe Code Your Own Game':'Vibe Code Your Own Game &middot; The Long Road'}</span><span>Bright Scholar · AI-Ready School</span></div>

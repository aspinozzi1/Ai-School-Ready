...
## Make it yours
- [ ] Replace at least one generic example with a real one from your classrooms
- [ ] Tell at least one story only you could tell
- [ ] Add specifics: grade levels, subject details, real constraints (class sizes,
      prep-time reality, the Wi-Fi in the gym)
- [ ] Cut anything you would never say out loud
...
style rule, your edit stays. Log what you changed in the kit's PROVENANCE.md.

## Sign-off
- [ ] Adam reviewed: ____________  date ________
- [ ] Katelyn reviewed: ____________  date ________
- [ ] PROVENANCE.md updated (what changed, what was added, approval date)

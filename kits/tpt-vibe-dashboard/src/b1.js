...
const APP=fs.readFileSync(path.join(__dirname,'classroom-dashboard.html'),'utf8');
...
<div class="foot"><span>Vibe Coding for Teachers &middot; Build a Classroom Dashboard</span><span>Bright Scholar &middot; AI-Ready School</span></div>

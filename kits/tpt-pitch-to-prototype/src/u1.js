...
const APP=fs.readFileSync(path.join(__dirname,'lost-and-found.html'),'utf8');
...
<div class="foot"><span>${stu?'Student page · Pitch to Prototype':'Pitch to Prototype · Vibe Coding for Kids'}</span><span>Bright Scholar · AI-Ready School</span></div>

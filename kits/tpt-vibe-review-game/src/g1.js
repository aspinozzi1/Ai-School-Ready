...
const APP=fs.readFileSync(path.join(__dirname,'boss-battle.html'),'utf8');
...
<div class="foot"><span>${stu?'Vibe Code Your Own Game':'Vibe Code Your Own Game · Boss Battle'}</span><span>Bright Scholar · AI-Ready School</span></div>

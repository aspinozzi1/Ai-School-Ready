...
function unitPages(u, n) {
  ...
  P.push(sheet(`
    ...
    <div style="display:flex;gap:9pt;margin-top:11pt">
      <div class="card" style="flex:1;text-align:center;padding:12pt 8pt"><div style="font-family:'Luckiest Guy',cursive;font-size:20pt;color:${u.colour};line-height:1.1">6</div><div style="font-size:9pt;font-weight:800;color:var(--grey)">practice pages</div></div>
      <div class="card" style="flex:1;text-align:center;padding:12pt 8pt"><div style="font-family:'Luckiest Guy',cursive;font-size:20pt;color:${u.colour};line-height:1.1">10</div><div style="font-size:9pt;font-weight:800;color:var(--grey)">probe words</div></div>
      <div class="card" style="flex:1;text-align:center;padding:12pt 8pt"><div style="font-family:'Luckiest Guy',cursive;font-size:20pt;color:${u.colour};line-height:1.1">4</div><div style="font-size:9pt;font-weight:800;color:var(--grey)">weeks of data</div></div>
      <div class="card" style="flex:1;text-align:center;padding:12pt 8pt"><div style="font-family:'Luckiest Guy',cursive;font-size:20pt;color:${u.colour};line-height:1.1">8/10</div><div style="font-size:9pt;font-weight:800;color:var(--grey)">to move on</div></div>
  ...
  P.push(sheet(`
    ...
    <div style="display:flex;gap:9pt;margin-top:9pt">
      <div class="card" style="flex:1;padding:11pt 14pt">
        <div style="font-family:'Fredoka',sans-serif;font-weight:600;font-size:11.5pt;color:var(--blue);margin-bottom:4pt">Colour a star for each word you read on your own</div>

# Kit 4 — Provenance log

Human-authorship chain for "AI for Assessment: Rubrics, Feedback, and Question Banks."
...
| Owner corrections at audit | 2026-08-08 | Three corrections, applied and verified: slide 3 and slide 12 stat cards rewritten so every number carries on-slide context; all death-metaphor phrasing ("catch and kill," "dies by your hand," "one dead weak question") replaced with catch-and-cut language across script and deck. Rule recorded in KIT_STANDARD voice. Kit 4's AI-drafted founders' note stood review with no changes requested. |

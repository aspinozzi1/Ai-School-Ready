...
<div class="kick">Vibe Coding for Teachers &middot; No Coding Background Needed</div>
...
<div class="card"><h3>The name for this</h3>
<p class="small" style="margin:0">You will see this called <b>vibe coding</b> &mdash; describing what you
want in plain language and letting the AI write the code. The term is used two ways. One means
accepting whatever comes back without looking. The other means what is on this page: describe,
check, correct, repeat. <b>This pack teaches the second one</b>, which is why page 8 is four
checks and page 10 tells you to test your own answer key. The checking is not an extra step
bolted on. It is the part that makes the result yours.</p></div>
<div class="row">

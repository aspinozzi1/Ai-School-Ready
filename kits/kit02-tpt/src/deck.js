...
(async () => {
  ...
  const RIVERA = [null, "Her gap: same tools as the weekly savers. The skill is what differs.",
    ...
    "Her review prompt, step 3: the specifics come out, the doc entry goes in.", null,
  ...
  // ============================== SLIDE 23 · LAB STEP 3 · HOW-TO ==============================
  {
    ...
    s.addNotes('Say: step three, turn what worked into a template. Replace the specifics with blanks, then paste the final version into the staff prompt doc with your name and a one-line note about what it is for. Confirm there are no student names in it, which is Kit 1\'s rule still with us. The next slide is her entry in the doc.');
  }
  ...
  // ============================== SLIDE 24 · LAB STEP 3 · HER SCREEN ==============================
  {
    ...
    riveraScreen(s, [
      ...
      { text: 'Mix multiple choice and short answer. Include an answer key.”', options: { color: GOOD, bold: true } },
    ], { fontSize: 17, lineSpacingMultiple: 1.2, caption: 'In the staff doc: Ms. Rivera · “weekly review questions, any topic”' });
    legendChips(s, FOUR_PARTS);
    s.addNotes('Say: the same prompt you watched her draft and iterate, with the weekly specifics swapped for blanks and pasted under her name. The four colors survive the swap, which is the point: the structure is the reusable part. Project the staff prompt doc; watching entries appear live is the session’s proudest moment.');
  }

...
(async () => {
  ...
  const RIVERA = [null, "Her gap: same tools as the weekly savers. The skill is what differs.",
    ...
    "Her review prompt, bracketed into a template and pasted into the staff doc.",
  ...
  // ============================== SLIDE 21 · LAB STEP 3 ==============================
  {
    ...
    s.addText('In the staff doc: Ms. Rivera · “weekly review questions, any topic”', {
    ...
    s.addNotes('Project the staff prompt doc link. Watching entries appear live is the session’s proudest moment. The big card is Ms. Rivera\'s finished template: the same review prompt from steps 1 and 2 with the specifics swapped for blanks, pasted under her name.');
  }

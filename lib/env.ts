 ...
 * The public marketing site runs WITHOUT any of these set, so nothing here
 * throws at import time — callers check the `*Configured` booleans and
 * degrade gracefully (auth pages explain, gated pages point to /pricing).
 */
...
export const env = {
  ...
  stripePriceSchool: process.env.STRIPE_PRICE_SCHOOL ?? "",
